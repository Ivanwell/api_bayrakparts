...
async function createItemWhole(articleArr, brandArr, title, error_path) {
    ...
    try {
        ...
        const searchImage = await searchImageInAllSupliers(articleArr, brandArr, error_path)
...
module.exports = { getDate, writeLogs, getUuid, createOnlyLinkInBM, getFirstImageForItemFromBM, getCategoryByUuid, devideOnChunks, updateAllEndedProducts,  createItemWhole, createItemDirect}